...
export class QuoteService {
    ...
    async getQuote(request) {
        try {
            ...
            throw new SDKError(`Failed to get quote: ${error.message}`, 'QUOTE_ERROR', 500, { request, error: error.message });
        }
    }
    async getOptimalRoute(params) {
        try {
            ...
            throw new SDKError(`Failed to get optimal route: ${error.message}`, 'ROUTE_ERROR', 500, { params, error: error.message });
        }
    }
    async getPoolLiquidity(poolAddress) {
        try {
            ...
            throw new SDKError(`Failed to get pool liquidity: ${error.message}`, 'POOL_LIQUIDITY_ERROR', 500, { poolAddress, error: error.message });
        }
    }
    async getSupportedTokens() {
        try {
            ...
            throw new SDKError(`Failed to get supported tokens: ${error.message}`, 'TOKENS_ERROR', 500, { error: error.message });
        }
    }
}
